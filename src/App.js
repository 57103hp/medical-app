...
const App = () => {
  ...
  cv["onRuntimeInitialized"] = async () => {
    ...
    const arrBufNet = await download(
      ...
      ["Loading Pose model", setLoading] // logger
    );
  ...
  return (
    <div className="App">
      ...
      <div className="header">
        <img
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS2CdBO5nEiXBecE1BNZH8qEu_P5dk8P9sTTQ&s"
          alt="Logo"
          className="logo"
        />
        ...
        <h4 id="time">0</h4>
        <p>
          Pose detection application live on browser powered by{" "}
          <code>meril-web</code>
        </p>
        {/* <p>
